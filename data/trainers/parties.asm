...
WhitneyGroup:
	...
	db 21, CLEFAIRY,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 22, SNUBBULL,   CHARM, BITE, HEADBUTT, ICE_PUNCH
...
BugsyGroup:
	...
	db 16, LEDIAN,    LIGHT_SCREEN, COMET_PUNCH, REFLECT, NO_MOVE
	db 17, ARIADOS     POISON_STING, STRING_SHOT, PURSUIT, NO_MOVE
	db 18, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, ROCK_SMASH
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 25, HAUNTER,    HYPNOSIS, MEAN_LOOK, CURSE, NIGHT_SHADE
	db 25, XATU,       CONFUSION, FAINT_ATTACK, NIGHT_SHADE, HAZE
...
PryceGroup:
	...
	db 42, DELIBIRD,   ICE_BEAM, QUICK_ATTACK, FLY, ICY_WIND
	db 43, STANTLER,   HEADBUTT, HYPNOSIS, EARTHQUAKE, SPITE
	db 43, DEWGONG,    SLEEP_TALK, ICY_WIND, SURF, REST
	db 44, PILOSWINE,  ICY_WIND, DIG, MIST, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 36, MAGNETON,   THUNDERBOLT, REST, SLEEP_TALK, THUNDER_WAVE
	db 37, FORRETRESS, SPIKES, SELFDESTRUCT, GIGA_DRAIN, DOUBLE_TEAM
	db 37, SKARMORY,   STEEL_WING, SKY_ATTACK, AGILITY, WHIRLWIND
	db 38, STEELIX,    SCREECH, SUNNY_DAY, ROCK_SLIDE, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 34, PRIMEAPE,   DIG, ROCK_SLIDE, KARATE_CHOP, HEADBUTT
	db 35, HERACROSS,  REVERSAL, ENDURE, STRENGTH, CURSE
	db 35, ELECTABUZZ, THUNDERPUNCH, FIRE_PUNCH, ICE_PUNCH, CROSS_CHOP
...
ClairGroup:
	...
	db 47, DRAGONAIR,  THUNDER_WAVE, SURF, BODY_SLAM, DRAGONBREATH
	db 47, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, BODY_SLAM, DRAGONBREATH
	db 47, AMPHAROS,  RAIN_DANCE, THUNDER, BODY_SLAM, THUNDER_WAVE
	db 47, GYARADOS,  RAIN_DANCE, HYDRO_PUMP, DOUBLE_EDGE, DRAGONBREATH
	db 48, KINGDRA,    ICE_BEAM, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
